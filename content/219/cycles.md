...
What if we do not have the execution time?

To find the execution time you need to know the number of clock cycles (CC) and its clock cycle time (CT)
The units of frequency is Hertz (Hz)
