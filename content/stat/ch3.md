...
A **distribution** shows the frequency or likelihood of various values occurring in a data set.

The **class width** of a given frequency distribution is the difference between the lower limits of the consecutive classes.  
...
$$
\t{Relative Frequency} = \frac{\t{Number in Category or Class}}{\t{Total Number of Observations}}
$$
...
The **Pareto chart** is a bar graph whose bars are arranged in decreasing order of frequency.
